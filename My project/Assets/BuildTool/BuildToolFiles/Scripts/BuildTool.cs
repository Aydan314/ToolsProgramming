...
[CreateAssetMenu(fileName = "BuildTool", menuName = "Scriptable Objects/BuildTool/BuildTool")]
[ExecuteInEditMode]
public class BuildTool : ScriptableObject
{
    ...
    // Loops through each node except the start node and applys a colour //
